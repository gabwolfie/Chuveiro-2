...
app.config["SQLALCHEMY_DATABASE_URI"] = f"sqlite:///{os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'data', 'app.db')}"
...
def handle_join_notifications():
    print('Cliente se inscreveu para notificações')
